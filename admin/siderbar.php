<h3><a href="<?php echo $websiteurl; ?>" class="uk-navbar-item uk-logo"><img uk-svg="" src="/skin/ukv3/images/uikit-logo.svg" class="uk-margin-small-right" hidden="true"><svg width="28" height="34" viewBox="0 0 28 34" xmlns="http://www.w3.org/2000/svg" class="uk-margin-small-right uk-svg" data-svg="/skin/ukv3/images/uikit-logo.svg">
...
<ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
    ...
    <li class="uk-parent">
        ...
        <ul class="uk-nav-sub">
            <li class="uk-active"><a href="reportStudent.php">查看学生</a></li>
            <li><a href="reportClass.php">查看班级</a></li>
            <li><a href="reportSchool.php">查看学校</a></li>
        </ul>
    </li>
    ...
    <li><a href="manSchool.php"><span class="uk-margin-small-right" uk-icon="icon: gitter"></span> 学校管理</a></li>
    <li><a href="manClass.php"><span class="uk-margin-small-right" uk-icon="icon: thumbnails"></span> 班级管理</a></li>
    <li><a href="manStudent.php"><span class="uk-margin-small-right" uk-icon="icon: users"></span> 学生管理</a></li>
